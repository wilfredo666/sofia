...
$pdf->setY(30);$pdf->setX(35);
$pdf->SetFont('Arial','B',15);
$pdf->Cell(5,$textypos,"FACTURA DE ALQUILER DE BIENES INMUEBLES");
...
/////////////////////////////
//// Array de Cabecera
$header = array("Cod. Servicio", "Cantidad","Descripcion","Precio unit","Descuento","Subtotal");
//// Arrar de Productos
$products = array(
